...
export const DEMO_DATA = {
  ...
  "ng-orders-v1": [
    ...
    // Shipped US history so the ship dialog's courier-cost panel has a lane to
    // read. Mirrors the real spread: Cirro-heavy, a few unlabelled, one USPS —
    // and deliberately mixes "US" with "United States" to exercise normalising.
    { id:"sh-1", platform:"etsy", order_number:"ETSY-3300001", etsy_receipt_id:3300001, date:d(50), currency:"INR", sale_price:5200, order_total:5200, status:"shipped", shipped_at:d(50), carrier_name:"cirro",     ship_cost:640, ship_country:"US",            listing_title:"Amethyst cluster", buyer_name:"S. Field" },
    { id:"sh-2", platform:"etsy", order_number:"ETSY-3300002", etsy_receipt_id:3300002, date:d(46), currency:"INR", sale_price:4900, order_total:4900, status:"shipped", shipped_at:d(46), carrier_name:"cirro",     ship_cost:700, ship_country:"United States", listing_title:"Rose quartz sphere", buyer_name:"J. Okafor" },
    { id:"sh-3", platform:"etsy", order_number:"ETSY-3300003", etsy_receipt_id:3300003, date:d(40), currency:"INR", sale_price:5400, order_total:5400, status:"shipped", shipped_at:d(40), carrier_name:"blue dart surface", ship_cost:305, ship_country:"US",     listing_title:"Carnelian palmstones", buyer_name:"M. Reyes" },
    { id:"sh-4", platform:"etsy", order_number:"ETSY-3300004", etsy_receipt_id:3300004, date:d(35), currency:"INR", sale_price:5100, order_total:5100, status:"shipped", shipped_at:d(35), carrier_name:"usps",      ship_cost:618, ship_country:"US",            listing_title:"Clear quartz point", buyer_name:"D. Halvorsen" },
    { id:"sh-5", platform:"etsy", order_number:"ETSY-3300005", etsy_receipt_id:3300005, date:d(30), currency:"INR", sale_price:5000, order_total:5000, status:"shipped", shipped_at:d(30), carrier_name:"india post", ship_cost:414, ship_country:"US",           listing_title:"Pyrite cluster", buyer_name:"A. Lindqvist" },
